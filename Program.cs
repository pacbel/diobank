...
namespace diobank
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            listContas.Add(new Conta(tipoConta.PessoaFisica, 700, 200, "Pacbel"));
            listContas.Add(new Conta(tipoConta.PessoaFisica, 1000, 500, "Carlos"));
            listContas.Add(new Conta(tipoConta.PessoaFisica, 1800, 0, "Thais"));
